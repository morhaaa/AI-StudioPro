  ...
  return (
    <div className="px-4 md:px-8 :px-12">
      <div className="bg-[#000814]/70 backdrop-blur-md flex flex-col  gap-2 md:gap-4 items-center rounded-md py-6 md:py-8">
        <h2 className="text-3xl md:text-4xl font-bold text-slate-50">Our features</h2>
        ...
        {features.map((ft, index)=>(<Card key={index} className="bg-[#000814] border-none flex flex-col p-2">
         <CardHeader className="flex flex-row items-center  gap-1 md:gap-3 ">
          ...
          <CardTitle className="text-white text-xl lg:text-2xl p-0">{ft.title}</CardTitle>         
         </CardHeader> 
          <CardContent className="text-white text-sm lg:text-md">{ft.description}</CardContent></Card>))}
        </div>
        </div>
